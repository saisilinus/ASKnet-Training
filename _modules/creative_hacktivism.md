...
module:
    ...
    res: [alternative_tools 'creative_hacktivist_term', 'hacktivism_examples', 'media_investigations_literacy', 'convivial_technologies', 'case_study_stella_nyanzi', 'alternative_tools', 'creative_hacktivism_slides']
    # marker
---  
